...
class scene(object):
    ...
    def enter(self):
        print "This scene is not yet configured .subclass itand implement enter()." 
        exit(1)
        
class Engine(object):
    
    def __init__(self, scene_map):
        print "Engine__init__has scene_map", scene_map
...
class CentralCorridor(scene):
    ...
    def enter(self):
        ...
        print "either enter shoot! or dodge! or tell a joke"
        action = raw_input("> ")
